...
const CitizenDashboard = ({ onLogout }: CitizenDashboardProps) => {
  ...
  const currentMonthPoints = currentMonthBookings.reduce(
    (sum, b) => sum + b.wasteCategory.ecoPointsPerUnit * b.actualQuantity,
    0,
  );
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [bookingsData, rewardsData, slotsData, totalPointsData] =
          await Promise.all([
        ...
        <div className="flex justify-between items-center mb-8 animate-fade-in">
          <div>
            ...
            <p className="text-white/70">
              Manage your eco-friendly waste pickups
            </p>
          </div>
            ...
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  <span>
                    {currentMonthPoints}/{monthlyTarget} points
                  </span>
                  <span className="text-muted-foreground">
                    {Math.round((currentMonthPoints / monthlyTarget) * 100)}%
                  </span>
                </div>
                <Progress
                  value={(currentMonthPoints / monthlyTarget) * 100}
                  className="h-2"
                />
              </div>
            </CardContent>
          ...
          >
            ...
            <CardContent>
              <div className="flex items-center gap-2">
                ...
                <span className="text-2xl font-bold">
                  {bookings.filter((b) => b.status === "COLLECTED").length}
                </span>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  Schedule a new waste pickup for your location
                </CardDescription>
              </CardHeader>
                  ...
                  <div className="space-y-3 mt-4 max-h-64 overflow-y-auto">
                    {slots.map((slot) => {
                      ...
                      const availableSpots =
                        slot.capacity - slot.currentBookingsCount;
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  Your latest waste pickup history
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      >
                        <div className="space-y-1">
                          ...
                          <div className="text-sm text-muted-foreground">
                            {booking.wasteCategory.name} Waste
                          </div>
                        </div>
                ...
                {rewards.map((reward) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <Badge variant="default">{reward.points} pts</Badge>
                    </div>
                    <Button
                      size="sm"
                      ...
                      className="w-full"
                      variant={
                        totalPoints >= reward.points ? "default" : "outline"
                      }
              ...
              <CardContent className="space-y-4">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-recycler-blue">
                    {(
                      bookings.reduce((sum, b) => sum + b.actualQuantity, 0) *
                      0.25
                    ).toFixed(1)}{" "}
                    kg
                  </div>
